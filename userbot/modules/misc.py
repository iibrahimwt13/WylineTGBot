...
async def sleepybot(time):
    """ .sleep komutu Fireqanq'ın birkaç saniye uyumasına olanak sağlar. """
...
CmdHelp('misc').add_command(
    'random', '<eşya1> <eşya2> ... <eşyaN>', 'Eşya listesinden rastgele bir eşya seçer', 'random fireqanq uniborg userge'
).add_command(
    'sleep', '<süre>', 'Fireqanq de bir insan, o da yoruluyor. Ara sıra biraz uyumasına izin ver.', 'sleep 30'
).add_command(
