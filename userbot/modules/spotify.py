...
def get_spotify_info(TIME=5):
    try:
        ...
        if len(item['album']['images']) > 0:
            ...
            if path.exists("@FireqanQUserBot-Spotify.jpg"):
                remove("@FireqanQUserBot-Spotify.jpg")          
            try:
                r = get(str(item['album']['images'][0]['url']))
                with open("@FireqanQUserBot-Spotify.jpg", 'wb') as f:
                    f.write(r.content)    

                with open('@FireqanQUserBot-Spotify.jpg', 'rb') as f:
